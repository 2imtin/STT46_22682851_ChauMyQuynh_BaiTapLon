...
function handleSearch(event) {
  ...
  if (query) {
      window.location.href = `https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/html/timkiem.html?query=${encodeURIComponent(query)}`;
  }
}
...
function updateUserSection() {
    ...
    if (loggedInUser) {
        userSection.innerHTML = `
            <a href="https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/html/thongtin.html" class="navbar-text ms-4">
        ...
        userSection.innerHTML = `
            <a href="https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/html/dangnhap.html" class="btn btn-secondary ms-4">Đăng nhập</a>
            <a href="https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/html/dangky.html" class="btn btn-success ms-4">Đăng ký</a>
        `;
  ...
  const products = [
    {
      id: 1,
      name: "Bưởi da xanh",
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/buoidaxanh.png",
      price: "85,000 đ",
    ...
    { 
      id:2,
      name: "Lựu Tứ Xuyên", 
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/luu.png", 
      price: "105,000 đ" ,
    ...
    { 
      ...
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/dualuoi.png", 
      price: "105,000 đ",
    ...
    { 
      ...
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/tao.png", 
      price: "145,000 đ",
    ...
    { 
      id:5,
      name: "Cam Úc", 
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/camuc.png", 
      price: "110,000 đ",
    ...
    },
    {
      ...
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/nhohanquoc.png",
      price: "785,000 đ",
    ...
    },
    {
      ...
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/kiwivang.png",
      price: "175,000 đ",
    ...
    },
    {
      ...
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/kiwixanh.png",
      price: "125,000 đ",
    ...
    { 
      id:9,
      name: "Nho xanh Mỹ", 
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/nhomy.png", 
      price: "325,000 đ",
    ...
    { 
      id:10,
      name: "Quýt Úc", 
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/quytuc.png", 
      price: "145,000 đ",
    ...
    },
    {
      ...
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/xoaicatchu.png",
      price: "105,000 đ",
    ...
    },
    {
      id:12,
      name: "Dừa xiêm",
      image: "https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/images/duaxiem.png",
      price: "15,500 đ",
...
function handleLogin(event) {
    ...
    if (!password) {
        ...
        if (email === userData.email && password === userData.password) {
            ...
            window.location.href = 'https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/index.html';
        } else {
...
function handleRegister(event) {
    ...
    window.location.href = 'https://2imtin.github.io/STT46_22682851_ChauMyQuynh_BaiTapLon/html/dangnhap.html';
    return true; 
}
const loggedInUser = JSON.parse(localStorage.getItem("loggedInUser"));
if (loggedInUser) {
